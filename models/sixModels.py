...
class ImageClassificationBase(nn.Module):
    def training_step(self, batch):
        ...
        loss_vgg16 = F.cross_entropy(out[3], labels) # Calculate loss
        loss_vgg19 = F.cross_entropy(out[4], labels) # Calculate loss
        loss_vgg13 = F.cross_entropy(out[5], labels) # Calculate loss
        return loss_resnet18, loss_resnet50, loss_resnet101, loss_vgg16, loss_vgg19, loss_vgg13
    ...
    def validation_step(self, batch):
        ...
        acc_vgg16 = accuracy(out[3], labels)
        acc_vgg19 = accuracy(out[4], labels)
        acc_vgg13 = accuracy(out[5], labels)
...
class HybridModel(ImageClassificationBase):
    ...
    def forward(self, x):
        ...
        return out_resnet_18, out_resnet_50, out_resnet_101, out_vgg_16, out_vgg_19, out_vgg_13
...
#         # Set up cutom optimizer with weight decay
    ...
    for epoch in range(epochs):
        ...
        for batch in train_dl:
            ...
            loss_resnet18, loss_resnet50, loss_resnet101, loss_vgg16, loss_vgg19, loss_vgg13 = model.training_step(batch)
        ...
        result_vgg16 = result[3]
        result_vgg19 = result[4]
        result_vgg13 = result[5]
        ...
        result = [result_resnet18, result_resnet50, result_resnet101, result_vgg16, result_vgg19, result_vgg13]
