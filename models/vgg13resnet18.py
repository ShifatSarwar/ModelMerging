...
class ImageClassificationBase(nn.Module):
    def training_step(self, batch):
        ...
        loss_vgg13 = F.cross_entropy(out[1], labels) # Calculate loss
        ...
        return loss_resnet18, loss_vgg13
    ...
    def validation_step(self, batch):
        ...
        acc_vgg13 = accuracy(out[1], labels)
    ...
    def validation_epoch_end(self, outputs):
        ...
        batch_losses_vgg13 = [x[1]['val_loss_vgg13'] for x in outputs]
        epoch_loss_vgg13 = torch.stack(batch_losses_vgg13).mean()   # Combine losses
        batch_accs_vgg13 = [x[1]['val_acc_vgg13'] for x in outputs]
...
class HybridModel(ImageClassificationBase):
    ...
    def forward(self, x):
        ...
        return out_resnet_18, out_vgg_13
...
#         # Set up cutom optimizer with weight decay
    ...
    for epoch in range(epochs):
        ...
        for batch in train_dl:
            ...
            loss_resnet18, loss_vgg13 = model.training_step(batch)
        ...
        result = [result_resnet18, result_vgg13]
