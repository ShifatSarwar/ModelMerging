...
class ImageClassificationBase(nn.Module):
    def training_step(self, batch):
        ...
        loss_vgg13 = F.cross_entropy(out[6], labels) # Calculate loss
        loss_vgg11 = F.cross_entropy(out[7], labels) # Calculate loss
    ...
    def validation_step(self, batch):
        ...
        acc_vgg13 = accuracy(out[6], labels)
        acc_vgg11 = accuracy(out[7], labels)
    ...
    def validation_epoch_end(self, outputs):
        ...
        batch_losses_resnet152 = [x[3]['val_loss_resnet152'] for x in outputs]
        epoch_loss_resnet152 = torch.stack(batch_losses_resnet152).mean()   # Combine losses
        batch_accs_resnet152 = [x[3]['val_acc_resnet152'] for x in outputs]
        ...
        batch_losses_vgg13 = [x[6]['val_loss_vgg13'] for x in outputs]
        epoch_loss_vgg13 = torch.stack(batch_losses_vgg13).mean()   # Combine losses
        batch_accs_vgg13 = [x[6]['val_acc_vgg13'] for x in outputs]
        epoch_acc_vgg13 = torch.stack(batch_accs_vgg13).mean()      # Combine accuracies

        batch_losses_vgg11 = [x[7]['val_loss_vgg11'] for x in outputs]
        epoch_loss_vgg11 = torch.stack(batch_losses_vgg11).mean()   # Combine losses
        batch_accs_vgg11 = [x[7]['val_acc_vgg11'] for x in outputs]
...
#         # Set up cutom optimizer with weight decay
    ...
    for epoch in range(epochs):
        ...
        result_vgg13 = result[6]
        result_vgg11 = result[7]
