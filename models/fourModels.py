...
class ImageClassificationBase(nn.Module):
    def training_step(self, batch):
        ...
        loss_vgg16 = F.cross_entropy(out[2], labels) # Calculate loss
        loss_vgg19 = F.cross_entropy(out[3], labels) # Calculate loss
        return loss_resnet18, loss_resnet50, loss_vgg16, loss_vgg19
    ...
    def validation_step(self, batch):
        ...
        acc_vgg16 = accuracy(out[2], labels)
    ...
    def validation_epoch_end(self, outputs):
        ...
        batch_losses_vgg16 = [x[2]['val_loss_vgg16'] for x in outputs]
        epoch_loss_vgg16 = torch.stack(batch_losses_vgg16).mean()   # Combine losses
        batch_accs_vgg16 = [x[2]['val_acc_vgg16'] for x in outputs]
...
class HybridModel(ImageClassificationBase):
    ...
    def forward(self, x):
        ...
        return out_resnet_18, out_resnet_50, out_vgg_16, out_vgg_19
...
#         # Set up cutom optimizer with weight decay
    ...
    for epoch in range(epochs):
        ...
        for batch in train_dl:
            ...
            loss_resnet18, loss_resnet50, loss_vgg16, loss_vgg19 = model.training_step(batch)
        ...
        result = [result_resnet18, result_resnet50, result_vgg16, result_vgg19]
